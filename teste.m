...
x_aco = [0.05; 0.05; 0.05; 0.15; 0.15; 0.15]; % Por se tratar de um problema de nFNC, não temos os dados de x_aco. Mas, desde que as barras estejam dispostas simetricamente em relação ao eixo Y, não há alteração no resultado final.
